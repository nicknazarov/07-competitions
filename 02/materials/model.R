...
#I estimated the likelihood to be late more than 90 days (using a gbm) and I included the estimation as a predictor.
#The new predictor was by far the most important predictor and boosted the accuracy.
